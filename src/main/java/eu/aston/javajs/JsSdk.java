...
public class JsSdk {
    ...
    public static void defineFunctions(Scope scope){
        ...
        scope.nativeFunction("String.endsWith(searchString,endPosition)", parentTypeFunction(String.class, JsSdk::string_endsWith));
        scope.nativeFunction("String.includes(searchString,position)", parentTypeFunction(String.class, JsSdk::string_includes));
        scope.nativeFunction("String.indexOf(searchValue,fromIndex)", parentTypeFunction(String.class, JsSdk::string_indexOf));
        scope.nativeFunction("String.lastIndexOf(searchValue,fromIndex)", parentTypeFunction(String.class, JsSdk::string_lastIndexOf));
        ...
        scope.nativeFunction("String.padEnd(targetLength,padString)", parentTypeFunction(String.class, JsSdk::string_padEnd));
        scope.nativeFunction("String.padStart(targetLength,padString)", parentTypeFunction(String.class, JsSdk::string_padStart));
        scope.nativeFunction("String.repeat(count)", parentTypeFunction(String.class, JsSdk::string_repeat));
        scope.nativeFunction("String.replace(searchFor,replaceWith)", parentTypeFunction(String.class, JsSdk::string_replace));
        scope.nativeFunction("String.replaceAll(searchFor,replaceWith)", parentTypeFunction(String.class, JsSdk::string_replaceAll));
        ...
        scope.nativeFunction("String.startsWith(searchString, position)", parentTypeFunction(String.class, JsSdk::string_startsWith));
        scope.nativeFunction("String.substring(start,end)", parentTypeFunction(String.class, JsSdk::string_substring));
        scope.nativeFunction("String.toLocaleLowerCase()", parentTypeFunction(String.class, JsSdk::string_toLocaleLowerCase));
        scope.nativeFunction("String.toLocaleUpperCase()", parentTypeFunction(String.class, JsSdk::string_toLocaleUpperCase));
        ...
        scope.nativeFunction("Array.copyWithin(target,start,end)", parentTypeFunction(List.class, JsSdk::array_copyWithin));
        ...
        scope.nativeFunction("Array.findLastIndex(callbackFn)", parentTypeFunction(List.class, JsSdk::array_findLastIndex));
        ...
        scope.nativeFunction("Array.includes(searchElement,fromIndex)", parentTypeFunction(List.class, JsSdk::array_includes));
        scope.nativeFunction("Array.indexOf(searchElement,fromIndex)", parentTypeFunction(List.class, JsSdk::array_indexOf));
        scope.nativeFunction("Array.join(separator)", parentTypeFunction(List.class, JsSdk::array_join));
        scope.nativeFunction("Array.lastIndexOf(searchElement,fromIndex)", parentTypeFunction(List.class, JsSdk::array_lastIndexOf));
        ...
        scope.nativeFunction("Array.reduce(callbackFn,initialValue)", parentTypeFunction(List.class, JsSdk::array_reduce));
        scope.nativeFunction("Array.reduceRight(callbackFn,initialValue)", parentTypeFunction(List.class, JsSdk::array_reduceRight));
    ...
    public static <T> BiFunction<Scope, List<Object>, Object> parentTypeFunction(Class<T> type, ScopeFunction<T> fn){
        return (scope, args)-> {
            ...
            if (thisParent != null && thisParent.value()!=null && type.isAssignableFrom(thisParent.value().getClass())) {
    ...
    public static Boolean string_endsWith(Scope scope, List<Object> args, String parent){
        ...
        if(endPosition > parent.length()) endPosition = parent.length();
    ...
    public static Boolean string_includes(Scope scope, List<Object> args, String parent){
        ...
        if(position > parent.length()) return false;
    ...
    public static Integer string_indexOf(Scope scope, List<Object> args, String parent){
        ...
        if(fromIndex > parent.length()) return -1;
    ...
    public static Integer string_lastIndexOf(Scope scope, List<Object> args, String parent){
        ...
        if(fromIndex > parent.length()) fromIndex = parent.length();
    ...
    public static String string_slice(Scope scope, List<Object> args, String parent){
        ...
        if(start < 0) start = parent.length() + start;
        if(end < 0) end = parent.length() + end;
        
        if(start < 0) start = 0;
        if(end > parent.length()) end = parent.length();
        if(start >= end) return "";
    ...
    public static String string_substring(Scope scope, List<Object> args, String parent){
        ...
        if(start > parent.length()) start = parent.length();
        if(end > parent.length()) end = parent.length();
    ...
    public static List<Object> array_copyWithin(Scope scope, List<Object> args, List<Object> parent) {
        ...
        if (target < 0) target = parent.size() + target;
        if (start < 0) start = parent.size() + start;
        if (end < 0) end = parent.size() + end;
    ...
    public static Boolean array_every(Scope scope, List<Object> args, List<Object> parent) {
        if (args.isEmpty() || parent.isEmpty()) return true;
    ...
    public static List<Object> array_flatMap(Scope scope, List<Object> args, List<Object> parent) {
        if (args.isEmpty()) return new ArrayList<>(parent);
    ...
    public static Boolean array_includes(Scope scope, List<Object> args, List<Object> parent) {
        ...
        if (fromIndex < 0) fromIndex = parent.size() + fromIndex;
        if (fromIndex < 0) fromIndex = 0;
    ...
    public static Object array_reduce(Scope scope, List<Object> args, List<Object> parent) {
        if (args.isEmpty()) return null;
        if (parent.isEmpty() && args.size() < 2) return null;
    ...
    public static List<Object> array_sort(Scope scope, List<Object> args, List<Object> parent) {
        if (parent.size() <= 1) return parent;
    ...
    public static List<Object> array_with(Scope scope, List<Object> args, List<Object> parent) {
        if (args.size() < 2) return new ArrayList<>(parent);
        
        int index = JsTypes.toNumber(args.getFirst()).intValue();
        Object value = args.get(1);
        
        if (index < 0) index = parent.size() + index;
